...
CREATE TABLE Catalog(Catalog_ID INT NOT NULL PRIMARY KEY,Location VARCHAR(50),Name VARCHAR(20));

CREATE TABLE Genre(Genre_ID INT NOT NULL PRIMARY KEY,Name VARCHAR(100),Description VARCHAR(300));

CREATE TABLE Material(Material_ID INT NOT NULL PRIMARY KEY,Title VARCHAR(80),Publication_Date DATE,
Catalog_ID INT,Genre_ID INT,FOREIGN KEY(Catalog_ID) REFERENCES Catalog(Catalog_ID),Foreign KEY(Genre_ID) REFERENCES Genre(Genre_ID));

CREATE TABLE Member(Member_ID INT NOT NULL PRIMARY KEY,Name VARCHAR(200),Contact_Info VARCHAR(160),Join_Date DATE);

CREATE TABLE Staff(Staff_ID INT NOT NULL PRIMARY KEY,Name VARCHAR(100),Contact_Info VARCHAR(150),Job_Title VARCHAR(100),Hire_Date DATE);

CREATE TABLE Author(Author_ID INT NOT NULL PRIMARY KEY,Name VARCHAR(100),Birth_Date DATE,Nationality VARCHAR(100));

CREATE TABLE Authorship(Authorship_ID INT NOT NULL PRIMARY KEY,Author_ID INT,Material_ID INT,
FOREIGN KEY(Author_ID) REFERENCES Author(Author_ID),FOREIGN KEY(Material_ID) REFERENCES Material(Material_ID));

CREATE TABLE Borrow(Borrow_ID INT NOT NULL PRIMARY KEY,Material_ID INT,Member_ID INT,Staff_ID INT,Borrow_Date DATE,Due_Date DATE,
Return_Date DATE,FOREIGN KEY(Material_ID) REFERENCES Material(Material_ID),FOREIGN KEY(Member_ID) REFERENCES Member(Member_ID),
...
VALUES(1,1,1),(2,2,2),(3,3,3),(4,4,4),(5,5,5),(6,6,6),(7,7,7),(8,8,8),(9,9,9),(10,10,10),(11,11,11),(12,12,12),(13,13,13),(14,14,14),
(15,15,15),(16,16,16),(17,17,17),(18,18,18),(19,19,19),(20,20,20),(21,1,21),(22,2,22),(23,3,22),(24,3,23),(25,4,24),(26,5,25),(27,6,26),
(28,7,27),(29,8,28),(30,19,28),(31,9,29),(32,10,30),(33,8,30),(34,2,29);

INSERT INTO Borrow(Borrow_ID,Material_ID,Member_ID,Staff_ID,Borrow_Date,Due_Date,Return_Date) 
VALUES(1,1,1,1,'2018-09-12','2018-03-10','2018-09-30'),
...
INSERT INTO Catalog(Catalog_ID,Name,Location)
values(11,'Research Papers','A2.1');
SELECT * FROM Catalog;
...
SELECT Title FROM Material WHERE Material_ID NOT IN(
SELECT Material_ID FROM Borrow WHERE Return_Date IS NULL);



-- Which materials are currently overdue? Suppose today is 04/01/2023, and show the borrow date and due date of each material. 
SELECT M.Title,B.Borrow_Date,B.Due_Date,M.Material_ID
...
SELECT M.Title, COUNT(*) AS Total_Count
FROM Material AS M
JOIN Borrow AS B ON M.Material_ID = B.Material_ID
GROUP BY M.Title
...
SELECT  COUNT(Material_ID) AS Count_Value_of_Lucas_Piki
FROM Authorship
WHERE Author_ID=(
    SELECT Author_ID
    FROM Author
...
SELECT COUNT(*) 
FROM(SELECT Material_ID FROM Authorship GROUP BY Material_ID HAVING COUNT(*)>1) AS 
authors;
...
FROM Borrow AS B
INNER JOIN Material AS M ON B.Material_ID=M.Material_ID
...
-- How do you update the “Harry Po er and the Philosopher's Stone” when it is returned on 04/01/2023? 
UPDATE Borrow
...
-- How do you add the following material to the database? Title: New book Date: 2020-08-01 Catalog: E-Books Genre: Mystery & Thriller Author: Lucas Luke 
INSERT INTO Material(Material_ID,Title,Publication_Date,Catalog_ID,Genre_ID) 
Values(32,'New book','2020-08-01',(SELECT Catalog_ID FROM Catalog WHERE Name='E-Books'),
...
INSERT INTO Authorship(Authorship_ID,Author_ID,Material_ID)
Values(35,(SELECT Author_ID FROM Author WHERE Name='Lucas LUke'),(SELECT Material_ID FROM Material WHERE Title='New book'));
